...
export default function AuthHome() {
  ...
  return <main className="auth-shell"><section className="auth-card">
    ...
    <button onClick={() => window.location.assign(import.meta.env.VITE_LABEL_TOOL_ORIGIN || `${window.location.protocol}//${window.location.hostname}:${import.meta.env.VITE_LABEL_TOOL_PORT}`)}>進入標註工具</button>
